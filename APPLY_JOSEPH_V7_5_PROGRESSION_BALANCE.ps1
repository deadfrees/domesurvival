...
function addNotice
'@
$Js = Replace-RequiredRegex $Js 'function openMain\(player\) \{.*?function addNotice' $OpenMain 'main situation page'
...
$Js = [regex]::Replace($Js, '^/\* Dome Survival - Joseph Cooper GUI .*?\*/', '/* Dome Survival - Joseph Cooper GUI v7.5 PROGRESSION BALANCE */', 1)
$Js = [regex]::Replace($Js, 'var GUI_NAME\s*=\s*"[^"]+";', 'var GUI_NAME = "dome_joseph_v75_progression_balance";', 1)
...
Write-Host "Joseph V7.5 - PROGRESSION BALANCE" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
