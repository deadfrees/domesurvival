...
public final class FormingPressJeiPlugin implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        LOGGER.info("[DomeSurvival/JEI] Registered forming-press GUI category v2");
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        if (level == null) {
            LOGGER.warn("[DomeSurvival/JEI] Client level is unavailable while registering forming recipes");
            return;
        }
