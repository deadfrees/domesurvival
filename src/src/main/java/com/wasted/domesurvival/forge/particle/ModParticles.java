...
public final class ModParticles {
    ...
    /** Soft translucent expanding membrane emitted from an oxygen filler in ventilation mode. */
    public static final RegistryObject<SimpleParticleType> VENTILATION_BUBBLE =
            PARTICLE_TYPES.register("ventilation_bubble", () -> new SimpleParticleType(false));
