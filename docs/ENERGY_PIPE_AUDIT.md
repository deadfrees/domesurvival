...
Продолжение по команде пользователя: greybox линейки, исходники Blender, ограничения и листы просмотра описаны в [ENERGY_PIPE_DESIGN.md](ENERGY_PIPE_DESIGN.md). Это отдельный этап после данного аудита; production models остаются прежними до согласования формы.
