...
Правка пользователя от 2026-09-13: сохранить форму текущих игровых труб. Фактические данные аудита остаются актуальными; прежние предложения увеличить диаметры и добавить новые кольца в разделах H–K заменены [актуальным ENERGY_PIPE_DESIGN.md](ENERGY_PIPE_DESIGN.md). Blender masters теперь импортируют действующие core/arm JSON без изменения геометрии.
...
Продолжение по команде пользователя: greybox линейки и последующее оформление Tier 1 описаны в [ENERGY_PIPE_DESIGN.md](ENERGY_PIPE_DESIGN.md). После уточнения «форма как текущие в игре» сохранена исходная геометрия; материалы и предмет Tier 1 обновлены. Сведения выше фиксируют состояние на момент аудита; текущие игровые проверки вынесены в [ENERGY_PIPE_TIER1_VALIDATION.md](ENERGY_PIPE_TIER1_VALIDATION.md).
